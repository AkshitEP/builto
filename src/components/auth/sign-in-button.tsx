...
export function SignInButton({ provider, callbackUrl = "/" }: SignInButtonProps) {
    ...
    return (
        <motion.button
            ...
            className={`w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${provider === "google"
                    ? "bg-white text-gray-900 hover:bg-gray-100"
                    : "bg-[#24292f] text-white hover:bg-[#30363d]"
                }`}
        >
            {provider === "google" ? (
